...
model1 = ModelManager.create_model(355, 80, learning_rate, regularization_factor)
...
model2 = ModelManager.create_model(355, 80, learning_rate, regularization_factor)
